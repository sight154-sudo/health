...
public class MessageConstant {
    ...
    public static final String USER_LOGIN_STATUS="用户未登录";
    ...
    public static final String UPDATE_MEMBER_STATUS_SUCCESS = "修改会员状态成功";
    public static final String UPDATE_MEMBER_STATUS_FAIL = "修改会员状态失败";
    ...
    public static final String REJECT_ORDER_SUCCESS = "拒绝订单成功";
    public static final String REJECT_ORDER_FAIL = "拒绝订单失败";
    public static final String QUERY_ADDRESS_SUCCESS = "查询地址列表成功";
    public static final String QUERY_ADDRESS_FAIL = "查询地址列表失败";
    public static final String ADD_ADDRESS_SUCCESS = "新增分公司地址成功";
    public static final String ADD_ADDRESS_FAIL = "新增分公司地址失败";
    public static final String EDIT_ADDRESS_SUCCESS = "修改地址数据成功";
    public static final String EDIT_ADDRESS_FAIL = "修改地址数据失败";
    ...
    public static final String GET_PAYURL_FAIL = "生成支付链接失败";
    public static final String GET_PAYURL_SUCCESS = "生成支付链接成功";
    public static final String PAY_FAIL = "支付失败";
    public static final String PAY_SUCCESS = "支付成功";
    public static final String CODE_TIMEOUT = "二维码超时";


    public static final String ADD_START_SUCCESS = "分院启用成功";
    public static final String ADD_START_FAIL = "分院启用失败";
